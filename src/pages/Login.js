...
export default class Login extends React.Component {
    ...
    render() {
        // Set number pincode
        let numbers = [{ id: 1 },{ id: 2 },{ id: 3 },{ id: 4 },{ id: 5 },{ id: 6 },{ id: 7 },{ id: 8 },{ id: 9 },{ id: "" },{ id: 0 }]
        return (
            <View style={ loginStyles.container }>
                ...
                <View style={ loginStyles.pinNumber }>
                    { numbers.map( num => {
                        return <TouchableOpacity style={ loginStyles.number } key={ num.id } onPress={ () => this.onPressNumber(num.id) }>
                            <Text style={ loginStyles.numberText }>{ num.id }</Text>
                        </TouchableOpacity>
                    })}
                    {/* pincode delete */}
                    <TouchableOpacity style={ loginStyles.number } onPress={ () => this.onPressDelete() }><FontAwesomeIcon icon={ faBackspace } size={ 40 } color={ "#fff" }/></TouchableOpacity>
                </View>
            </View>
        )
    }
